...
export default function Home() {
  ...
  return (
    <main className="flex w-full min-h-screen flex-col items-center justify-center gap-y-5 mt-0 md:p-20 bg-radial-gradient md:justify-center">
      ...
      <div className=' flex flex-col justify-between items-center gap-2 pb-4 md:gap-1 md:mb-8'>
        <h1 className='drop-shadow-md font-medium text-3xl md:text-5xl animate-text text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-white'>Edson Lucas</h1>
