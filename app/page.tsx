...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-radial-gradient md:justify-center md:gap-5">
      <LinesAnimationPattern />
      <Image className='z-10 drop-shadow-md' src={'/foto-pag-links.png'} alt='' width={201} height={201} />
      <div className=' flex flex-col justify-between items-center gap-2 md:gap-1 md:mb-8'>
        <h1 className='drop-shadow-md font-medium text-2xl md:text-5xl md:animate-text md:text-transparent md:bg-clip-text md:bg-gradient-to-r md:from-purple-400 md:to-white'>Edson Lucas</h1>
